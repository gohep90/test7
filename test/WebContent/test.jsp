...
<body>
	<p style="margin-top: 12px">
		사용한 데이터를 보시려면 <em class="link"> <a href="http://localhost:8080/blueboard/eduJson.do" target="_blank">여기를 클릭하세요!</a>
		</em>
	</p>
	...
	<script>
		...
		$.get("http://localhost:8080/blueboard/eduJson.do", function(data) {
			alert(data);
